...
export declare function useReactMediaRecorder({ audio, video, onStop, blobPropertyBag, screen, mediaRecorderOptions, askPermissionOnMount }: ReactMediaRecorderHookProps): ReactMediaRecorderRenderProps;
